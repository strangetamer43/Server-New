...
export const createPost = async (req, res) => {
    ...
    //     const newPost = new PostMessage({ title, message, tags, name, avatarUrl, videoUrl: video, creator: req.userId, createdAt: new Date().toISOString() });
    ...
    //     const newPost = new PostMessage({ title, message, tags, name, avatarUrl, imageUrl: image, creator: req.userId, createdAt: new Date().toISOString() });
    ...
    //     const newPost = new PostMessage({ title, message, tags, name, avatarUrl, imageUrl: image, videoUrl: video, creator: req.userId, createdAt: new Date().toISOString() });
...
export const deletePost = async (req, res) => {
    ...
    const post = await PostMessage.findById(id);
    if (post.public_id) {
        cloudinary.uploader.destroy(post.public_id, function (result) { console.log("image deleted") });
    } else {
